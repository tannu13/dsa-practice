use crate::sols_cf::pattern_printing::{
    ...
    p_hollow_diamond::write_hollow_diamond, q_crown::write_crown, r_butterfly::write_butterfly,
    s_inverted_diamond::write_inverted_diamond,
};

mod sols_cf;

fn main() {
    write_inverted_diamond(6);
}
